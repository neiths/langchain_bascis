...
PROMPTS = {
    "1": """
        ...
        If user provide you time length, number of questions, and difficulty level, you can create a math exam for them.
    ...
    "4": """
        ...
        If you can't solve the problem, you need to escalate the issue to the next level of support. 
        And response to the user awaiting for another support.
